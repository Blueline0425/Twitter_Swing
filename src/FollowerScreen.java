...
public class FollowerScreen {
    private JFrame frame;

    public FollowerScreen() {
        // JFrame 설정
        frame = new JFrame("Follower");
        ...
        JLabel titleLabel = new JLabel("Follower", JLabel.CENTER);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(FollowerScreen::new);
    }
}
